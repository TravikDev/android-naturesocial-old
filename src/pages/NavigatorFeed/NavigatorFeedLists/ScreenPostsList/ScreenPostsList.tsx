...
import { PostsListCard } from '../../../organisms/Posts/PostsList/PostCard/PostsListCard'
import { FeedPostCard } from '../../../organisms/Feed/FeedPostCard'
import { Children, useState } from 'react'
import { PostSortContainer } from '../../../organisms/Posts/PostsList/PostSortContainer/PostSortContainer'
...
export const ScreenPostsList = ({ navigation }) => {
    ...
    const posts = [
        { id: 1, title: 'First title', categories: 'App updates', content: 'Studies show that ultrasonic signals are an important aspect of plant life strategy and can serve as a means of protection and survival in difficult conditions. ', imageUrl: 'https://telegra.ph/file/72e0bab08f0f093d54952.png' },
        ...
        { id: 3, title: 'Third title', categories: 'Science', content: ' Scientists from Arizona State University have developed a new method that allows for the precise determination of the ripening moment of fruits and vegetables.', imageUrl: 'https://telegra.ph/file/354e1beb9b4e3174ef135.png' },
    ]
        ...
        <ScrollView contentContainerStyle={{ backgroundColor: '#fff' }}>
            ...
            <View style={{ marginHorizontal: 10 }}>
                ...
                <View style={{ gap: 10 }}>
                    ...
                    {posts.map(post => (
                        <View key={post.id}>
                            <FeedPostCard postId={post.id} title={post.title} categories={post.categories} imageUrl={post.imageUrl} navigation={navigation}>
                                {post.content}
                            </FeedPostCard>
                        </View>
                    ))}
