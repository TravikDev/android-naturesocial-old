...
import { PostFilterSingleCategories } from '../../PostFilterSingleCategories'

export const PostFilterContainer = ({ isExpanded = false }) => {
    ...
    return (
        <View>
            {isExpanded && (
                <View style={{ width: '100%', backgroundColor: '#fbfbfb', borderColor: '#ccc', borderWidth: 1, borderRadius: 5, gap: 10, zIndex: 10, marginBottom: 10 }}>
